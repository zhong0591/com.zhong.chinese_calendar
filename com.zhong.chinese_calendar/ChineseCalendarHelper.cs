...
namespace com.zhong.chinese_calendar
{
    public class ChineseCalendarHelper
    {
        ...
        public static async Task<YearSpecialDate> GetYearSpecialDatesFromRemoteAsync(int year)
        {
        ...
        public static async Task<YearSpecialDate> GetSpecialDatesByYearAsync(int year, string webRootPath)
        {
        ...
        public static async Task<bool> CheckDateIsHolidayAsync(DateTime date, string webRootPath)
        {
            var yearSpecialDate = await GetSpecialDatesByYearAsync(date.Year, webRootPath);
